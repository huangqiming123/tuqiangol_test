...
public class AccountCenterNaviBarPage extends AutomateDriver {
	...
	public String helloUserAccount(){
		String HelloUser=super.getElement("c,user-name").getText();
		return HelloUser;
	}
	
    public String usrInfoName(){
        String UsrName = super.getElement("userName").getText();
        return UsrName;
    }

    public String usrInfoAccount(){
        String UsrAccount = super.getElement("userAccount").getText();
        return UsrAccount;
    }

    public String usrInfoType(){
        String UsrType = super.getElement("userType").getText();
        return UsrType;
    }

    public String usrInfoPhone(){
        String UsrPhone = super.getElement("userPhone").getText();
        return UsrPhone;
    }
